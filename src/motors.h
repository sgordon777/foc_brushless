...
#elif defined(MOT_HUB)
#define CONTROL_TYPE (MotionControlType::velocity)
#define SUPPLY_V (12)
#define DRIVER_V_LIMIT (12)
#define MOTOR_V_LIMIT (2)
#define MOTOR_I_LIMIT (100.0)
#define MOTOR_VEL_LIMIT (77.0)
#define SENSOR_ALIGN_V (0.5)
#define MOTOR_PP (15)
#define MOTOR_RES (1.0)
#define MOTOR_K (22)
#define MOTOR_IND (0.000220)
#define VEL_P (0.05)
#define VEL_I (0.1)
#define VEL_D (0.0)
#define VEL_R (0.0)
...
#define MOTOR_V_LIMIT (2)
#define MOTOR_I_LIMIT (100.0)
#define MOTOR_VEL_LIMIT (300.0)
#define SENSOR_ALIGN_V (0.5)
#define MOTOR_PP (3)
#define MOTOR_RES (0.1)
#define MOTOR_K (300)
#define MOTOR_IND (0.000030)
#define VEL_P (0.5)
#define VEL_I (6.0)
#define VEL_D (0.0)
#define VEL_R (0.0)
